...
class DeviceAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # dropdown дээр code - гэдгийг алга болгох
        ...
        if not aimag_id and instance and instance.location_id and instance.location and instance.location.aimag_ref_id:
            aimag_id = instance.location.aimag_ref_id

        if not sum_id and instance and instance.location_id and instance.location and instance.location.sum_ref_id:

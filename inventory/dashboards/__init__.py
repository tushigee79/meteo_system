            ...
            items.append(
                {
                    ...
                    "type": "movement",
                    "title": "Ð‘Ð°Ð¹Ñ€ÑˆÐ¸Ð» ÑˆÐ¸Ð»Ð¶Ð¸Ð»Ñ‚",
                    "detail": f"{getattr(getattr(m,'source',None),'name', '')} â†’ {getattr(getattr(m,'destination',None),'name','')}".strip(),
                }
            )
    except Exception:
        pass
            ...
            items.append(
                {
                    ...
                    "type": "maintenance",
                    "title": "Ð—Ð°ÑÐ²Ð°Ñ€ Ò¯Ð¹Ð»Ñ‡Ð¸Ð»Ð³ÑÑ",
            ...
            items.append(
                {
                    ...
                    "type": "control",
                    "title": "Ð¥ÑÐ½Ð°Ð»Ñ‚/Ñ‚Ð¾Ñ…Ð¸Ñ€ÑƒÑƒÐ»Ð³Ð°",
...
def build_workflow_pending_counts():
    ...
    # DeviceMovement Ð´ÑÑÑ€ workflow_status Ð±Ð°Ð¹Ñ…Ð³Ò¯Ð¹ Ð±Ð°Ð¹Ð¶ Ð¼Ð°Ð³Ð°Ð´Ð³Ò¯Ð¹ Ñ‚ÑƒÐ» safe
    try:
...
def build_map_points(
    ...
    Filters are best-effort; wonâ€™t crash if fields differ.
    """
